...
```
cd existing_repo
git remote add origin http://SRV-SWE-GIT.atoma.local/schelske/bouncingball.git
git branch -M master
...
- [ ] [Set up project integrations](http://SRV-SWE-GIT.atoma.local/schelske/bouncingball/-/settings/integrations)
